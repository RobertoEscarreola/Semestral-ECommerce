...
""" View de Página de Inicio """
def home(request):
	banners=Banner.objects.all().order_by('-id')
	data=Product.objects.filter(is_featured=True).order_by('-id')
	return render(request,'index.html',{'data':data,'banners':banners})

""" View de Lista de Categorías """
def category_list(request):
    data=Category.objects.all().order_by('-id')
    return render(request,'category_list.html',{'data':data})

""" View de Lista de Marcas """
def brand_list(request):
    data=Brand.objects.all().order_by('-id')
    return render(request,'brand_list.html',{'data':data})

""" View de Lista de Productos """
...
""" View de Categorías de Productos """
...
""" View de los Detalles de Producto """
def product_detail(request,slug,id):
	...
	""" Si el usuario está Autenticado peude añadir Reviews """
	canAdd=True
...
""" View para Borrar Artículo del Carrito """
...
""" View de Pago Cancelado """
@csrf_exempt
def payment_canceled(request):
	return render(request, 'payment-fail.html')


""" View para Guardar Reviews """
...
""" View para añadir a la Lista de Deseos """
...
""" View para Actualizar Dirección """
